    ...
    variants: {
      type: {
        ...
        [ButtonType.Secondary]: [
          ...
          "hover:enabled:bg-pz-component-button-bg-secondary-hover",
          "hover:enabled:border-pz-system-border-hover",
          "hover:enabled:text-pz-system-fg-hover",
          "active:enabled:bg-pz-component-button-bg-secondary-pressed",
        ...
        [ButtonType.Ghost]: [
          ...
          "hover:enabled:bg-pz-component-button-bg-ghost-hover",
          "hover:enabled:text-pz-component-button-fg-ghost-hover",
